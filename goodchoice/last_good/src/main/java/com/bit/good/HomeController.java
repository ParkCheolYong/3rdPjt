...
import com.bit.good.dao.InquiryDao;
...
public class HomeController {
	...
	public String write(HttpServletRequest request, Model model) {
		Edao dao = sqlSession.getMapper(Edao.class);
		dao.writeDao(request.getParameter("sub"), request.getParameter("startdate"), request.getParameter("enddate"),
				request.getParameter("thumbnail"), request.getParameter("bodyimage"));
	...
	public String write2(HttpServletRequest request, Model model) {
		...
		Idao dao2 = sqlSession.getMapper(Idao.class);
		dao2.writeDao2(request.getParameter("sub"), request.getParameter("sub2"), request.getParameter("content"),
	...
	public String inquiryWrite(HttpServletRequest request, Model model) {
		InquiryDao dao = sqlSession.getMapper(InquiryDao.class);
		dao.inquiryWriteDao(request.getParameter("email"), request.getParameter("category"), request.getParameter("type"), request.getParameter("phone"), request.getParameter("contents"));
